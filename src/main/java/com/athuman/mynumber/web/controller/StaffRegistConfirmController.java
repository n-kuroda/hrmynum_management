...
public class StaffRegistConfirmController {
	...
	private List<String> getIdentification(StaffInfoModel myNumberRegist) {
		...
		// add 本人であることが明らか if check box Clear Person has checked
		lstIdentification = checkIdentification(
				myNumberRegist.getClearPerson(), lstIdentification,
				ConstValues.CLEAR_PERSON);
	 ...
	 * @return List<String>
	 */
	private List<String> checkIdentification(String item, List<String> lts,
			String itemName) {
